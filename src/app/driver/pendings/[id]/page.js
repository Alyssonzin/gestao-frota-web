                        ...
                        <Carousel className="border border-black">
                            <CarouselContent>
                                <CarouselItem className="flex justify-center">
                                    <Image src={motorista.profile_doc_picture || "/logomarca.jpg"} alt="Imagem1" width={300} height={300} />
                                </CarouselItem>
                                <CarouselItem className="flex justify-center">
                                    <Image src={motorista.cnh_picture || "/logomarca.jpg"} alt="Imagem2" width={300} height={300} />
                                </CarouselItem>
                            </CarouselContent>
                            <CarouselPrevious />
                            <CarouselNext />
